...
# Desenhar a estrela no topo do triângulo
t.penup()
t.goto(4, 80)  # Ajuste sutil para mover a estrela para o centro
t.pendown()
t.color("yellow")
t.fillcolor("yellow")

# Preencher a estrela com cor (aumentar um pouco o tamanho)
t.begin_fill()
for _ in range(5):
    t.forward(12)  # Aumentando o tamanho do lado da estrela
    t.right(144)
    t.forward(12)  # Aumentando o tamanho do lado da estrela
    t.left(72)
t.end_fill()
